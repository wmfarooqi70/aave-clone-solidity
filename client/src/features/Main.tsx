...
import PhoenixToken from "../smart-contracts/chain-info/PhoenixToken.json"
import { Snackbar, Typography, makeStyles } from "@material-ui/core"
import Alert from "@material-ui/lab/Alert"
import networkMapping from "../smart-contracts/chain-info/map.json"
import brownieConfig from "../smart-contracts/brownie-config-json.json"
...
export const Main = () => {
  ...
  const PhoenixTokenAddress = chainId ? networkMapping[String(chainId)]["PhoenixToken"][0] : constants.AddressZero
  const wethTokenAddress = chainId ? brownieConfig["networks"][networkName]["weth_token"] : constants.AddressZero
  const fauTokenAddress = chainId ? brownieConfig["networks"][networkName]["fau_token"] : constants.AddressZero
  console.log("PhoenixTokenAddress", PhoenixTokenAddress)
  /**
   ...
   * 
   * Modularize the addresses like with `PhoenixTokenAddress`
